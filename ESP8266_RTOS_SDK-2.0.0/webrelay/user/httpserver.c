...
"<b>"
"<div class=\"text\" style=\" text-align:center;\"><big>by anna开发  WIFI智能家居</big>"
"</b>"
"</font>"
"<font size=\"12\" color=\"yellow\">"
"<b>"
...
"<div style=\" center\" id=\"txtState\">插座状态未知</div>"
"</font>"
"<br></br>"
		...
		for(;;)
		{
			...
			if(cfd != -1)
			{
				...
				if(ret > 0)
				{
					...
					{
						if(isLedTurnOpen)//点击的时候，如果是打开的，1，就为真，关闭
						{
							Relay_Control(0);
						...
						{
							Relay_Control(1);
							send(cfd,"插座已经打开",strlen("插座已经打开"),0);
							isLedTurnOpen = true;
						}
					}
				}
